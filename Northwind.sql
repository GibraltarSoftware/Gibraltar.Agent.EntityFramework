...
-- --------------------------------------------------
-- Generated from EDMX file: C:\Development\Git\Gibraltar.Agent.EntityFramework\Src\Agent.EntityFramework.Test\Entities\Northwind.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_EmployeesTerritories_Employees]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EmployeesTerritories] DROP CONSTRAINT [FK_EmployeesTerritories_Employees];
GO
IF OBJECT_ID(N'[dbo].[FK_EmployeesTerritories_Territories]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EmployeesTerritories] DROP CONSTRAINT [FK_EmployeesTerritories_Territories];
GO
...
GO
IF OBJECT_ID(N'[dbo].[EmployeesTerritories]', 'U') IS NOT NULL
    DROP TABLE [dbo].[EmployeesTerritories];
GO
IF OBJECT_ID(N'[dbo].[InternationalOrders]', 'U') IS NOT NULL
...
GO
IF OBJECT_ID(N'[dbo].[PreviousEmployees]', 'U') IS NOT NULL
...
-- Creating table 'InternationalOrders'
...
-- Creating table 'PreviousEmployees'
...
-- Creating table 'EmployeesTerritories'
...
-- Creating primary key on [OrderID] in table 'InternationalOrders'
ALTER TABLE [dbo].[InternationalOrders]
ADD CONSTRAINT [PK_InternationalOrders]
...
-- Creating primary key on [EmployeeID] in table 'PreviousEmployees'
ALTER TABLE [dbo].[PreviousEmployees]
ADD CONSTRAINT [PK_PreviousEmployees]
    PRIMARY KEY CLUSTERED ([EmployeeID] ASC);
GO
...
-- Creating primary key on [Employees_EmployeeID], [Territories_TerritoryID] in table 'EmployeesTerritories'
ALTER TABLE [dbo].[EmployeesTerritories]
ADD CONSTRAINT [PK_EmployeesTerritories]
...
-- Creating foreign key on [Employees_EmployeeID] in table 'EmployeesTerritories'
ALTER TABLE [dbo].[EmployeesTerritories]
ADD CONSTRAINT [FK_EmployeesTerritories_Employees]
...
-- Creating foreign key on [Territories_TerritoryID] in table 'EmployeesTerritories'
ALTER TABLE [dbo].[EmployeesTerritories]
ADD CONSTRAINT [FK_EmployeesTerritories_Territories]
    FOREIGN KEY ([Territories_TerritoryID])
    REFERENCES [dbo].[Territories]
        ([TerritoryID])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_EmployeesTerritories_Territories'
CREATE INDEX [IX_FK_EmployeesTerritories_Territories]
ON [dbo].[EmployeesTerritories]
